...
import masterlogo from "../images/maestro.png";
import {SOURCE, NOOFTICKETS } from "./Bcomponent"
...
class Payment extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({ total: sessionStorage.getItem(NOOFTICKETS) * 650 });
    this.setState({
    });
    this.setState({
      total:
        sessionStorage.getItem(NOOFTICKETS) * 650 -
        sessionStorage.getItem(NOOFTICKETS) * 650 * (10 / 100)
    });
  }
